...
export interface ApiPartnerPartner extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::partner.partner'
    >;
    partnerList: Schema.Attribute.Component<'elements.partner-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerCompanyLinks: Schema.Attribute.Component<'links.nav-link', true>;
    footerServiceLinks: Schema.Attribute.Relation<
      'oneToMany',
      'api::service.service'
    >;
    ...
    navLinks: Schema.Attribute.Component<'links.nav-link', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workshopAddress: Schema.Attribute.Text;
  };
}
